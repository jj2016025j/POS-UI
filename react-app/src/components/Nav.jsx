                    ...
                    <div className="navbar-collapse justify-content-end" id="navbarScroll">
                        <ul className="navbar-nav"
                            ...
                            <li className="nav-item h3">
                                <a className="nav-link active" aria-current="page" href="/"><b>首頁</b></a>
                            </li>
                            <li className="nav-item h3">
                                <a className="nav-link active" href="/news"><b>最新活動</b></a>
                            </li>
                            <li className="nav-item dropdown h3">
                                ...
                                <ul className="dropdown-menu w-50"
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="/menu_base"><b>鍋物湯底</b></a>
                                    </li>
                                    <hr />
                                    <li>
